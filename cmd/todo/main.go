...
func main() {
	...
	// Check if the user defined the NEW VAR for a custom file name
	...
	// Use the Get method to read the todo items from file
	...
	case *delete > 0:
		if *delete > len(*l) {
			fmt.Fprintln(os.Stderr, "Invalid task number, here is a list of existing tasks:")
			fmt.Print(l)
			os.Exit(1)
		}
